...
const InsiderNetworks = () => {
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                  {insider.companies.map((company, idx) => (
                    <div key={idx} className="text-sm">
                      ...
                      <div className={`text-xs ${insider.avg_performance > 0 ? 'text-green-600' : 'text-red-600'}`}>
            ...
            {networks.trading_clusters?.map((cluster, index) => (
              <div key={index} className="border rounded-lg p-4 hover:bg-gray-50">
                <div className="flex justify-between items-start mb-3">
                  <div>
                    <h4 className="font-medium text-gray-900">{cluster.company}</h4>
                    <p className="text-sm text-gray-500">{cluster.month}</p>
                  </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                  <div>
                    ...
                    <p className="font-medium">{cluster.insider_count}</p>
                  </div>
                  <div>
                    <span className="text-gray-500">Total Volume</span>
                    <p className="font-medium">{formatCurrency(cluster.total_volume)}</p>
                  </div>
                  <div>
                    <span className="text-gray-500">Buys</span>
                    <p className="font-medium text-green-600">{cluster.buy_count}</p>
                  </div>
                  <div>
                    <span className="text-gray-500">Sells</span>
                    <p className="font-medium text-red-600">{cluster.sell_count}</p>
                  </div>
                </div>
              </div>
            ))}
        ...
        return (
          <div className="space-y-4">
            ...
            {networks.family_networks?.map((family, index) => (
              <div key={index} className="border rounded-lg p-4 hover:bg-gray-50">
                <div className="flex justify-between items-start mb-3">
                  <h4 className="font-medium text-gray-900">{family.family_name} Family Network</h4>
                  <div className="text-right">
                    <div className="text-sm text-gray-500">{family.member_count} members</div>
            ...
            {networks.investmentNetworks?.map((firm, index) => (
              <div key={index} className="border rounded-lg p-4 hover:bg-gray-50">
                <div className="flex justify-between items-start mb-3">
                  ...
                  <div className="text-right">
                    <div className="text-sm text-gray-500">{firm.portfolioSize} companies</div>
                    <div className="text-sm font-medium">
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Insider Networks</h1>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-gray-500">Board Overlaps</p>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-gray-500">Executive Migrations</p>
                <p className="text-lg font-semibold text-gray-900">
                  0
                </p>
              </div>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-gray-500">Family Networks</p>
                <p className="text-lg font-semibold text-gray-900">
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-gray-500">Trading Clusters</p>
                <p className="text-lg font-semibold text-gray-900">
