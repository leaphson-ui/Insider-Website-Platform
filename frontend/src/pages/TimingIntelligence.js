...
const TimingIntelligence = () => {
      ...
      {timingData.day_patterns?.map((dayData, index) => (
       <div key={index} className="border rounded-lg p-4">
        <div className="flex justify-between items-center mb-3">
         <h4 className="font-medium text-primary">{dayData.day_name}</h4>
       ...
       <div key={insider.name} className="border rounded-lg p-4 ">
        <div className="flex justify-between items-start mb-3">
         <div>
          ...
          <p className="text-sm text-secondary">{insider.trade_count} trades analyzed</p>
         </div>
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
         <div>
          <span className="text-secondary">Preferred Day</span>
         ...
         <div>
          <span className="text-secondary">Preferred Month</span>
          <div className="flex items-center">
           <span className="font-medium text-primary">
        ...
        <div className="mt-3">
         <div className="text-xs text-secondary">
          Performance Score: <span className="font-medium text-primary">{insider.performance_score?.toFixed(1) || 'N/A'}</span>
         </div>
        </div>
       </div>
      ))}
     ...
     <div className="space-y-4">
      ...
      {timingData.market_events?.map((event, index) => (
       <div key={index} className="border rounded-lg p-4">
        <div className="flex justify-between items-start mb-3">
         <div>
          <h4 className="font-medium text-primary">{event.event}</h4>
         ...
         <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
          ...
          event.type === 'recovery' ? 'bg-purple-100 text-purple-800' :
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
         <div>
          <span className="text-secondary">Trades Before</span>
          <p className="font-medium">{event.tradesBeforeCount}</p>
         </div>
         <div>
          <span className="text-secondary">Trades After</span>
          <p className="font-medium">{event.tradesAfterCount}</p>
         </div>
         <div>
          <span className="text-secondary">Volume Before</span>
          <p className="font-medium">{formatCurrency(event.volumeBefore)}</p>
         </div>
         <div>
          <span className="text-secondary">Buy/Sell Before</span>
 ...
 return (
  <div className="space-y-6">
   {/* Header */}
   <div>
    <h1 className="text-3xl font-bold text-primary">Timing Intelligence</h1>
