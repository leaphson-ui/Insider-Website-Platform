...
rm -f analyze_all_structures.py
...
echo "🗑️  Removing analysis output files..."
rm -f sec_structure_analysis_detailed.json
rm -f sec_structure_summary.json
rm -f processing.log
...
echo ""
echo "🎯 Your core work is preserved and ready for dashboard development!"
